...
html += '<input type="text" name="name_prod_standardsizenames" class="display_none" value="'+select_names+'">';
	...
	detail_html += "<div class='pp-col p-padding_lr_1rem pm6'><div class='pp-col pp-text-field ps12'><label>" + el.det_name + "</label><input name='name_prod_"+el.det_name.replace(/ /g,'')+"_details' placeholder='" + capitalize(el.det_name) + "'  type='text' " + required + "/></div></div>";
