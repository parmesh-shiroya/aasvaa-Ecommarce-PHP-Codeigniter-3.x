...
if (isset($add_status) && $add_status == true) {?>
	...
	<form class="pp-form" id="add_product_form" action="<?php echo base_url('admin/prodman/addproduct2/add_product'); ?>" enctype="multipart/form-data" method="post">
		<div class="pp-col pm12">
				...
				<div class="pp-row">
					...
					<div class="pp-col pp-padres pm5">
						<div class="pp-col pp-text-field ps12">
							...
							<input placeholder="Catalog Name" name="name_catalog_name" required type="text" class=" ">
						</div>
					</div>
					<div class="pp-col pp-padres pm12">
						<div class="pp-col pp-text-field ps12">
			...
			<!-- <div class="card hidden image_upload">
						<div class="pp-row">
									<div class="pp-col pp-padres pm12">
													<h5 class="grey-text center-align">Images</h5>
									</div>
									<div class="pp-col pp-padres pm7">
													<div class="file-field input-field">
																	<div class="btn">
																					<span>Select</span>
																					<input type="file" class="image_file_button" multiple name="imagesFile[]" >
																	</div>
			...
			<div class="card image_upload">
				<div class="pp-row pp-padres pp-center">
					<div class="pp-col pm12">
						...
						<input type="hidden" name="images" required value="" class="hidden images_names">
					</div>
					...
					<div  id="sortable" class="pp-col image-upload-box pp-margin-t-7 ps6">
						<div onclick=";" class="pp-col margin-lr-7 zero_padding image-select-button pointer add-image-button center valign-center ps2">
							<input id="image_file_button_2" type="file" style="width: 100%; height: 100%; position: relative; left: 0; top: 0; " class="image_file_button_2 opacity0"  name="imagesFile[]" >
					...
					<div class="pp-col pp-padres pm12">
						...
						<div class="pp-col pm6">
							<div class="switch">
								<label>
									Off
									<input type="checkbox"  name="name_prod_standardsize_checkbox" checked class="standard_checkbox pp-show_div_on_check" pp-div_class="standard_size_div">
    ...
    <option selected value="1">1 Kg</option>
					...
					<div class="pp-col pp-padres pm6">
						<div class="pp-col pp-text-field ps12">
							...
							<select required name="name_prod_shippingtime" class="browser-default grey-text text-darken-1">
								...
								<option value="3-4 Working Days">3-4 Working Days</option>
								<option value="10-12 Working Days">10-12 Working Days</option>
							</select>
						</div>
					</div>
						...
						detail_html += '<div class="input-field pp-lr-padres pp-col ps3">';
									...
									detail_html += '<select det-data-id="'+el.det_data_id+'" det-name="'+el.det_name+'" class="material_select detail-select grey-text text-darken-3 " multiple ';
												...
												detail_html += '<select det-data-id="'+el.det_data_id+'" det-name="'+el.det_name+'" class="material_select detail-select grey-text text-darken-3 pp-col ps12" ';
															...
															detail_html += "<option value='" + val + "'>" + val + "</option>";
															});
