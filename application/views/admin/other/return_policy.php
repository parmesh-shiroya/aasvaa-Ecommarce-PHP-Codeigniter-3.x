<div class="pp-row zero_margin grey-text text-darken-3">
		<div class="pp-col zero_padding ps12 card">
			<div class="pp-col center font-roboto_slab p-padding_tb_7 teal ps12 ">
				<h6 class="white-text font20">Return Policy</h6>
			</div>
			<div class="pp-col ps12 pp-padres">
				<form action="" method="post" id="return_policy_form">
...
jQuery(document).ready(function($) {
	$("#return_policy_form").on('submit', function(event) {
...
$("#return_policy_form").on('submit', function(event) {
	...
	$.post(base_url+'admin/other/Pages/return_policy_update', {data: data}, function(data, textStatus, xhr) {
		console.log(data);
if (data.result == true) {
