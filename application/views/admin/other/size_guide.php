<div class="pp-row zero_margin grey-text text-darken-3">
		<div class="pp-col zero_padding ps12 card">
			<div class="pp-col center font-roboto_slab p-padding_tb_7 teal ps12 ">
				<h6 class="white-text font20">Size Guide</h6>
			</div>
			<div class="pp-col ps12 pp-padres">
				<form action="" method="post" id="size_guide_form">
					<textarea name="editor1" id="editor1" rows="10" cols="80">
					<?php if (isset($size_guide_html)) {
...
$("#size_guide_form").on('submit', function(event) {
	event.preventDefault();
	var data = CKEDITOR.instances.editor1.getData()
	$.post(base_url+'admin/other/Pages/size_guide_update', {data: data}, function(data, textStatus, xhr) {
		console.log(data);
if (data.result == true) {
