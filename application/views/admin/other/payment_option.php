<div class="pp-row zero_margin grey-text text-darken-3">
		<div class="pp-col zero_padding ps12 card">
			<div class="pp-col center font-roboto_slab p-padding_tb_7 teal ps12 ">
				<h6 class="white-text font20">Payment Option</h6>
			</div>
			<div class="pp-col ps12 pp-padres">
				<form action="" method="post" id="payment_option_form">
					<textarea name="editor1" id="editor1" rows="10" cols="80">
					<?php if (isset($payment_option_html)) {
							echo $payment_option_html;
					}?>
					</textarea>
...
$("#payment_option_form").on('submit', function(event) {
	...
	$.post(base_url+'admin/other/Pages/payment_option_update', {data: data}, function(data, textStatus, xhr) {
		console.log(data);
if (data.result == true) {
