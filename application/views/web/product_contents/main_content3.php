...
form_return = 0;
	...
	$.each(names,function(index, el) {
				...
				main_price += parseInt($("[name='"+el.replace(/\s/g,'')
+"radio']:checked").attr('this-price'));
				// alert(main_price);
	});
	...
	$(".pincode_txb").css('border', '1px solid #b7b7b7');
		$(".pincode-message").css('color', '#212121');
		$(".pincode-message").html('Standard Delivered In 3-4 Days.'+shipping_charge);
	}else if(data[0].expected_delivery_days > 5 && data[0].expected_delivery_days <= 10){
	$(".pincode_txb").css('border', '1px solid #b7b7b7');
		$(".pincode-message").css('color', '#212121');
		$(".pincode-message").html('Standard Delivered In 7-8 Days.'+free_shipping);
	}else{
	$(".pincode_txb").css('border', '1px solid #b7b7b7');
		$(".pincode-message").css('color', '#212121');
		$(".pincode-message").html('Standard Delivered In '+data[0].expected_delivery_days+' Days.'+free_shipping);
	}
				}else{
	$(".pincode_txb").css('border', '1px solid #EA4335');
		$(".pincode-message").css('color', '#212121');
		$(".pincode-message").text('Delivery Not Availabel in that area.');
				}
				}else{
	$(".pincode_txb").css('border', '1px solid #EA4335');
		$(".pincode-message").css('color', '#212121');
