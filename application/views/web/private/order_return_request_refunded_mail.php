...
<table style="border-collapse:collapse;table-layout:fixed;min-width:320px;width:100%;background-color:#fff" border="0">
  ...
  <tbody >
    ...
    <tr style="font-family:'roboto',sans-serif;">
      ...
      <p style="font-size:14px; letter-spacing: 0.6px;">Your Order's price (Rs. <?php echo $order_mst->return_com_price; ?> (<?php echo $this->ccr->cc('INR', $order_trn_data['currency_choose'], $order_mst->return_com_price); ?>)) is refunded in your specified <?php echo $order_mst->return_com_transfer_in; ?> Account. It will take  upto 4 business days to credit the accunt.</p>
