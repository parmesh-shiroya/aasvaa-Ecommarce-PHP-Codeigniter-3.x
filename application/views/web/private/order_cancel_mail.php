...
<table style="border-collapse:collapse;table-layout:fixed;min-width:320px;width:100%;background-color:#fff" border="0">
  ...
  <tbody >
    ...
    <tr style="font-family:'roboto',sans-serif;">
      ...
      <p style="font-size:14px; letter-spacing: 0.6px;">Your Order has been Cancelled.</p>

      <?php
if ($order_status->status_text == 'By Customer') {?>
  <p style="font-size:14px; letter-spacing: 0.3px; color: #999;">We would like to inform you that we have processed your cancellation request Of The Order <?php echo $order_mst->order_id; ?>.</p>
<?php } else if ($order_status->status_text == 'By Admin') {?>
<p style="font-size:14px; letter-spacing: 0.3px; color: #999;">We Cancel your order. Because '<?php echo $order_status->message; ?>'. If You have any question regarding this Contact us.</p>
<?php }
