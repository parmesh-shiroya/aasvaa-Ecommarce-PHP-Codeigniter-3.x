...
<table style="border-collapse:collapse;table-layout:fixed;min-width:320px;width:100%;background-color:#fff" border="0">
  ...
  <tbody >
    ...
    <tr style="font-family:'roboto',sans-serif;">
      ...
      <p style="font-size:14px; letter-spacing: 0.6px;">You Request for return against this order has been received. thank you for shopping with Aasvaa.</p>

  <p style="font-size:14px; letter-spacing: 0.3px; color: #999;">We started processing your request and will get in touch with you shortly with updates.</p>
<p style="font-size:14px;letter-spacing: 0.3px; color: #999;">We will study the issue based on information provide by you and based on the return policy, accept the return request. Else we will provide the reason for non-acceptance.</p>
<?php
if ($order_mst->payment_from != 'cod') {?>
<p style="font-size:14px; letter-spacing: 0.3px; color: #999;">The amount you have paid for this order will be refunded back. We will notify you via E-mail and SMS when the refund is processed.</p>
<?php }?>
      </div></td>
    </tr>
    <tr  style="font-family:'roboto',sans-serif;">
