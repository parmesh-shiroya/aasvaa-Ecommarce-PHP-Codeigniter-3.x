...
<table style="border-collapse:collapse;table-layout:fixed;min-width:320px;width:100%;background-color:#fff" border="0">
  ...
  <tbody >
    ...
    <tr style="font-family:'roboto',sans-serif;">
      ...
      <p style="font-size:14px; letter-spacing: 0.6px;">Your Order has been Shipped.</p>
      <p style="font-size:14px; letter-spacing: 0.3px; color: #999;">Delivery is track and we will keep you updated as your order is being delivered. Meanwhile, you can check the status of your order on Aasvaa.com </p>
      <p>
        <center>
