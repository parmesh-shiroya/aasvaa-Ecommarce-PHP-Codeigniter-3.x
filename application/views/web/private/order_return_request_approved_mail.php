...
<table style="border-collapse:collapse;table-layout:fixed;min-width:320px;width:100%;background-color:#fff" border="0">
  ...
  <tbody >
    ...
    <tr style="font-family:'roboto',sans-serif;">
      ...
      <p style="font-size:14px; letter-spacing: 0.6px;">Your Request For return Order is Approved.</p>
      <p style="font-size:14px; letter-spacing: 0.3px; color: #999;">We schedule Pick up form your address. Pick up should take 2-3 Days. You have to Ready the Parcel with proper packing and Label.</p>
      <p style="font-size:13px; letter-spacing: 0.3px; color: #999;">Download label from your order panel and attach with parcel. For get label click On 'Track Order' Button.</p>
      <?php if ($order_mst->payment_from != 'cod') {?>
<p style="font-size:14px; letter-spacing: 0.3px; color: #999;">The amount you have paid for this order will be refunded back after We get Parcel. We will notify you via E-mail and SMS when the refund is processed.</p>
<?php }?>
      <p>
        <center>
