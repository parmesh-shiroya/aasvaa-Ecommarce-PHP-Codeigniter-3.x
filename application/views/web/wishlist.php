...
<div class="pp-col z-depth-05 border-1px pm12 pl8">
		...
		<div class="pp-col zero_padding wish_list_box valign-wrapper ps12">
			...
			<div class="pp-col pp-margin-t-7 pp-padding-l-15 ps9 pm10 pl10 pxl11">
				<div class="pp-col ps12">
					<a href="<?php echo $product_url; ?>"><h6 class="primary-text pp-margin-tb-4 name-title truncate font-roboto_slab"><?php echo $product->product_name; ?></h6></a>
				</div>
				<div class="pp-col ps12">
					<h6 class="grey-text font12 pp-margin-tb-4 text-darken-1">Sku :-					                                                                 <?php echo $product->product_sku; ?></h6>
				</div>
				<div class="pp-col ps12">
					<h6 class="grey-text text-darken-4 g8fs13 pp-margin-tb-4 font-500"><?php echo $this->ccr->cc('INR', $_SESSION['currency_choose'], $product->sell_price); ?></h6>
				</div>
				<div class="pp-col ps12">
				<h6 class="grey-text text-darken-3">
				<span class="pp-padding-r-15 pp-zero_padding_in_small hover-text-primary"><button product-id="<?php echo $product->product_id; ?>" class="c-bbtnp waves-effect pointer btn_add_to_cart h8plr10 h28 g8fs11">Add To Cart</button></span>
