...
class Payment_option extends My_Controller {
	...
	public function index() {
		$data['payment_option']     = base64_decode($this->model->get_data_from_templete_mst('payment_option_html')->datas);
		...
		$this->load->view('web/payment_option', $data);
