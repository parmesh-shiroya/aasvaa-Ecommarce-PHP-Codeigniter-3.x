...
class Size_guide extends My_Controller {
	...
	public function index() {
		$data['size_guide']         = base64_decode($this->model->get_data_from_templete_mst('size_guide_html')->datas);
		...
		$this->load->view('web/size_guide', $data);
