...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    return function(a, b, c, d) {
        ...
        var v = t.CSS = {
            ...
            setPropertyValue: function(a, c, d, e, f) {
                var h = c;
                if ("scroll" === c)
                    f.container ? f.container["scroll" + f.direction] = d : "Left" === f.direction ? b.scrollTo(d, f.alternateValue) : b.scrollTo(f.alternateValue, d);else if (v.Normalizations.registered[c] && "transform" === v.Normalizations.registered[c]("name", a)) v.Normalizations.registered[c]("inject", a, d), h = "transform", d = g(a).transformCache[c]; else {
                    if (v.Hooks.registered[c]) {
                        var i = c,
                            j = v.Hooks.getRoot(c);
    ...
    function R(a, b) {
        ...
        for (e = 0; e < g.length;) d[g[e].identifier] && h.push(g[e]), b & (Aa | Ba) &&
    ...
    j(Q, y, {
        ...
        handler: function(a, b, c) {
            var d = c.pointerType == ta,
                e = c.pointerType == va;
            if (d)
                this.mouse.allow = !1;else if (e && !this.mouse.allow) return;
...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity, function(a) {
    ...
    a.fn.scrollTo = function(b) {
        ...
        return "open" === b ? (this.each(function() {
            ...
            function d(c) {
                "focus" === c && (h = !0), b(), i.addClass("active"), f.addClass("active"), g.constrain_width === !0 ? i.css("width", f.outerWidth()) : i.css("white-space", "nowrap");var d = window.innerHeight,
                    e = f.innerHeight(),
                    j = f.offset().left,
        ...
        a(this).each(function() {
            ...
            if (!d.hasClass("browser-default")) {
                ...
                j.length && j.each(function() {
                    if (a(this).is("option"))
                        e ? n(d, a(this), "multiple") : n(d, a(this));else if (a(this).is("optgroup")) {
        ...
        var s = !1,
            ...
            y = x.prototype = {
                ...
                off: function() {
                    var a, b,
                        c = arguments;
                    for (a = 0, namesCount = c.length; a < namesCount; a += 1) b = c[a], b in t.methods &&
                        delete t.methods[b];
                    return y
                },
        ...
        init: function(b) {
            ...
            return b = a.extend(c, b), this.each(function() {
                    ...
                    function m(a) {
                        var b, c, f;
                        if (r)
                            if (b = d(a), y = e(a), c = u - b, f = Math.abs(v - y), 30 > f && !F) (c > 2 || -2 > c) && (E = !0, u = b, g(p + c)); else {
                    ...
                    var o, p, q, r, s, t, u, v, w, x, z, A, B, C, D, E, F,
